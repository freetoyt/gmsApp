package com.gms.app.daehanfactory.dialog;
...
import com.gms.app.daehanfactory.R;
import com.gms.app.daehanfactory.adapter.CustomerProductAdaptor;
import com.gms.app.daehanfactory.domain.CustomerProductVO;
...
public class StockReportOwnerDialog {
    ...
    */
        if(buttonType.equals("재고현황")){
            message.setText("!(주)대한특수가스");

            new HttpAsyncTaskB().execute(host + context.getString(R.string.api_customrBottleList) +"customerNm=!(주)대한특수가스");
        }
            ...
            try {
                ...
                if(result.equals("fail")){
                    ...
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            // 사용하고자 하는 코드
                            Toast.makeText(StockReportOwnerDialog.this.context, "등록에 실패했습니다.", Toast.LENGTH_SHORT).show();
                        }
                    }, 0);
                    ...
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            // 사용하고자 하는 코드
                            Toast.makeText(StockReportOwnerDialog.this.context, "사용자 정보가 없습니다.", Toast.LENGTH_SHORT).show();
                        }
                    }, 0);
                }
            } catch (IOException e) {
