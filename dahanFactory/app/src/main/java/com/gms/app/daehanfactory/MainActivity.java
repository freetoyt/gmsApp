...
import com.gms.app.daehanfactory.dialog.DummyDialog;
import com.gms.app.daehanfactory.dialog.ManualDialog;
import com.gms.app.daehanfactory.dialog.NoGasDialog;
import com.gms.app.daehanfactory.dialog.TankDialog;
import com.gms.app.daehanfactory.dialog.CashDialog;
import com.gms.app.daehanfactory.domain.BottleVO;
...
public class MainActivity extends AppCompatActivity implements BottomSheetDialog.BottomSheetListener {
    ...
    private Button btn_logout, btn_setting,
            btn_salesgas, btn_salesBack,btn_agencyRent, btn_agencyBack ,
            btn_come,btn_out,btn_money, btn_mass,
            btn_dummy, btn_ln2, btn_noGas, btn_tank,
       ...
       // Toast.makeText(MainActivity.this, "onResume.", Toast.LENGTH_SHORT).show();
        ...
        if(!isScan) {
            ...
            if (arrStr != null && arrStr.length() > 1) {
                ...
                Button btn_info = findViewById(R.id.btn_tank);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_salesgas = (Button)findViewById(R.id.btn_salesgas);         // 가스판매
        btn_salesBack = (Button)findViewById(R.id.btn_salesBack);       // 대리점 판매회수
        btn_agencyRent= (Button)findViewById(R.id.btn_agencyRent);         // 대리점대여
        btn_agencyBack = (Button)findViewById(R.id.btn_agencyBack);       // 대리점회수
        ...
        btn_noGas = (Button)findViewById(R.id.btn_noGas);       // 대리점재고
...
//        linearLayoutManager.setStackFromEnd(true);
        ...
        btn_salesgas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                Toast.makeText(MainActivity.this, "용기를"+btn_salesgas.getText().toString(), Toast.LENGTH_SHORT).show();
                if(arrayList.size() <= 0){
                    ...
                    CustomDialog customDialog = new CustomDialog(MainActivity.this,  btn_salesgas.getText().toString());
        ...
        btn_salesBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(arrayList.size() <= 0){
                    ...
                    CustomDialog customDialog = new CustomDialog(MainActivity.this,  btn_salesBack.getText().toString());
        ...
        btn_agencyRent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(arrayList.size() <= 0){
                    ...
                    CustomDialog customDialog = new CustomDialog(MainActivity.this,  btn_agencyRent.getText().toString());
        ...
        btn_agencyBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(arrayList.size() <= 0){
                    ...
                    CustomDialog customDialog = new CustomDialog(MainActivity.this,  btn_agencyBack.getText().toString());
...
/*
        btn_reportAgency.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                StockReportDialog customDialog = new StockReportDialog(MainActivity.this,btn_reportAgency.getText().toString());
        ...
        Thread thread = new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    mSocket.connect();
//                    if(mSocket.isConnected()) Log.i("***************** MainActivity  beginListenForData mSocket","mSocket connect");
