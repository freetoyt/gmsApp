...
import com.gms.app.factory.adapter.MassAdapter;
import com.gms.app.factory.adapter.MassData;
import com.gms.app.factory.dialog.MassDialog;
import com.gms.app.factory.dialog.MassManualDialog;
...
public class MassActivity extends AppCompatActivity {
    ...
    private Button btn_massProduct, btn_massSale, btn_massRent, btn_massBack, btn_massRentBack,btn_goBack , btn_massCome, btn_massOut,
            btn_mmanual,btn_mscan,btn_info;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_info  = (Button)findViewById(R.id.btn_info);     //앱정보
...
//        linearLayoutManager.setStackFromEnd(true);
        ...
        btn_massProduct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MassDialog massDialog = new MassDialog(MassActivity.this,btn_massProduct.getText().toString());
