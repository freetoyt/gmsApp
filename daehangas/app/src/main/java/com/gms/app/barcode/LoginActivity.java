...
//            Log.d("LoginActivity","checkSelfPermissionACCESS_FINE_LOCATION="+this.checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION));
...
//            Log.d("LoginActivity","checkSelfPermission BLUETOOTH_SCAN="+this.checkSelfPermission(Manifest.permission.BLUETOOTH_SCAN));
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
//            Log.d("LoginActivity","checkSelfPermission BLUETOOTH_CONNECT="+this.checkSelfPermission(Manifest.permission.BLUETOOTH_CONNECT));
